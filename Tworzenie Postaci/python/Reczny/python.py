...
post('tworzenie_postaci', {'ktora': '1', 'rasa': 'Dragonborn', 'klasa': 'Furia_i_Wscieklosc'})
post('tworzenie_postaci', {'ktora': '2', 'rasa': 'Dragonborn', 'klasa': 'Mistrz_Miecza'})
post('tworzenie_postaci', {'ktora': '3', 'rasa': 'Dwarf', 'klasa': 'Przywiazanie_do_natury'})
post('tworzenie_postaci', {'ktora': '4', 'rasa': 'Elf', 'klasa': 'Magia_paktow_i_Cienie'})
post('tworzenie_postaci', {'ktora': '5', 'rasa': 'Human', 'klasa': 'Magia_paktow_i_Cienie'})
post('tworzenie_postaci', {'ktora': '6', 'rasa': 'Tiefling', 'klasa': 'Magia_paktow_i_Cienie'})
